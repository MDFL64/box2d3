...
# -sASSERTIONS=2
export EMCC_CFLAGS="-g -msimd128 -mbulk-memory --js-library=$JS_LIB -sUSE_SDL=2 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 -sALLOW_MEMORY_GROWTH=1 -sSTACK_SIZE=131072 -Wno-unused-command-line-argument"
